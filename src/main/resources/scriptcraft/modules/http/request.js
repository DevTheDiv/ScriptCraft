...
/*global exports, encodeURIComponent, server, __plugin__, setTimeout*/
...
function invokeLater(fn) {
  server.scheduler['runTaskAsynchronously(org.bukkit.plugin.Plugin, java.lang.Runnable)'](__plugin__, fn);
  return;
}
